"""
Chat API — project chat with AI specialists.
"""
...
from app.schemas import ChatRequest, ChatResponse, SpecialistResponse
from app.engine import call_specialist
from app.personas import filter_context_for_specialist, SPECIALISTS
from mock_context import get_context_for_project, get_persona_access_for_project
...
async def chat(request: ChatRequest):
    ...
    # Build context per specialist and run in parallel
